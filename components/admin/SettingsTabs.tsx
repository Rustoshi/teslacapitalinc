                                ...
                                <form onSubmit={handleAddBankPayment} className="bg-white/[0.02] border border-white/[0.15] rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="accountName" type="text" required placeholder="e.g. Tesla Capital Inc." className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-red-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
